...
const Calculator: React.FC = () => {
	...
	useEffect(() => {
		// set monthly EMI context
		if (result) {
			setMonthlyEMI(Number(result.monthlyPayment.toFixed(2)));
		}
	}, [result, setMonthlyEMI]);
				...
				<>
					...
					>
						<Typography variant="h3" gutterBottom>
							Monthly EMI: {getCurrencySymbol(selectedCurrency)}
